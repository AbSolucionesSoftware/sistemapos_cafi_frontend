...
import { Box, Button, TextField, Dialog, DialogContent, DialogActions } from '@material-ui/core';
...
export default function CrearTallasProducto({ setMedidasSeleccionadas, refetch }) {
	...
	return (
		<Fragment>
			...
			<Dialog open={open} onClose={() => toggleModal()} scroll="paper" disableEscapeKeyDown disableBackdropClick>
				<DialogContent>
					<Box>
						...
						<Box display="flex" justifyContent="center" alignItems="center" my={2}>
							<form id="form-registro-color" onSubmit={(e) => GuardarDatosBD(e)}>
								<TextField
									id="outlined-error-helper-text"
									label={datos_generales.tipo_producto === 'ROPA' ? 'Talla' : 'Número'}
									variant="outlined"
									size="small"
                                    focused
									fullWidth
				...
				<DialogActions>
					<Button variant="outlined" color="primary" onClick={() => toggleModal()} size="large">
						Cancelar
					</Button>
					<Button
						variant="contained"
