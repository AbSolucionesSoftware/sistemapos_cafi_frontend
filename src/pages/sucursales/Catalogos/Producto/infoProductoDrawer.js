...
import { Drawer, Typography, Box, Grid, Button, IconButton } from '@material-ui/core';
...
export default function InfoProductoDrawer({producto }) {
	...
	return (
		<div>
            <IconButton color="default" variant="contained" onClick={() => toggleDrawer()}>
				<ListAlt  />
			</IconButton>
			<Drawer anchor="right" open={open} onClose={() => toggleDrawer()}>
                ...
                <Box position="absolute" bottom={16} width="100%" display="flex" justifyContent="center">
                    <Button variant="contained" color="primary" size="large" onClick={() => toggleDrawer()} startIcon={<Close />}>
                        Cerrar
                    </Button>
                </Box>
			</Drawer>
